...
<?= $currentView->includeView('System/form',['fields'=>array_slice($fields, 3)]); ?>
<div class="form-group border p-2 d-none" id="pallets_info">
	<h5 class="font-weight-bold">Pallet 1</h5>
